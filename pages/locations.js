...
function renderLocations() {
  ...
  <section class="chapter" id="locations">
      ...
      ${tc('The Weather', 'Wrong · God-Influenced', `<p>The weather still exists but it's wrong. Rain happens but it's warm and slightly the wrong color.</p><p>Storms are Vertex god activity and they're more frequent and more violent than natural storms should be. <br> The anti-storm infrastructure in Solaria is extensive. In the Undercroft people can tell a natural storm from a god by sound.</p>`)}
